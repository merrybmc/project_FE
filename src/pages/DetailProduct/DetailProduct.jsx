...
function DetailProduct() {
  ...
  const { mutate: orderMutation } = useOrderMutation();
  ...
  const onOrderProduct = () => {
    const koreanDateString = selectedDate.toLocaleDateString('ko-KR', {
      year: 'numeric',
      month: '2-digit',
      day: '2-digit',
      weekday: 'long'
      ...
      <S.detailPage>
        ...
        <S.flexDiv book={true}>
          <img
            ...
            alt='페이코 간편 결제'></img>
          <S.Button onClick={onOrderProduct}> 예매하기</S.Button>
        </S.flexDiv>
